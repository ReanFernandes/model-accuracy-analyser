...
The application is designed to work with a CSV file containing results from model evaluation experiments. While somewhat flexible, it works best with columns similar to the original `final_run_results.csv`, including:
...
2.  **Clone the Repository (Optional):**
    ```bash
    git clone https://github.com/ReanFernandes/model-accuracy-analyser.git
